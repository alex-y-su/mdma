...
const StatusMessageRunning = ({ t }: { t: (key: string) => string }) => (
  <IconStatusMessage
...
const StatusMessageSuccess = ({ t }: { t: (key: string) => string }) => (
  <IconStatusMessage
    className={`${baseClass}__status-message`}
...
const StatusMessageFailed = ({ exitCode, t }: { exitCode: number; t: (key: string, options?: any) => string }) => (
  <IconStatusMessage
    className={`${baseClass}__status-message`}
...
const StatusMessageError = ({ message, t }: { message: React.ReactNode; t: (key: string, options?: any) => string }) => (
  <IconStatusMessage
    className={`${baseClass}__status-message`}
    iconName="error-outline"
