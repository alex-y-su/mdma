...
- `url` is the EST (Enrollment Over Secure Transport) endpoint provided by Tau Platform.
- `client_id` is the client ID provided by Tau Platform.
- `client_secret` is the client secret provided by Tau Platform.
